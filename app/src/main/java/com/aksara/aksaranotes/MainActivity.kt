...
import com.aksara.aksaranotes.ui.settings.SecuritySettingsActivity
import com.aksara.aksaranotes.ui.settings.AboutActivity
import com.aksara.aksaranotes.ui.settings.HelpActivity
import com.aksara.aksaranotes.utils.BiometricHelper
import com.aksara.aksaranotes.utils.SessionManager
...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    fun checkNoteAccess(note: com.aksara.aksaranotes.data.database.entities.Note, onAccessGranted: () -> Unit) {
        if (note.requiresPin) {
