...
import com.aksara.aksaranotes.databinding.ActivityHelpBinding
...
class HelpActivity : AppCompatActivity() {
    ...
    private fun setupClickListeners() {
        ...
        // Video Tutorials
        binding.cardVideoTutorials.setOnClickListener {
            openVideoTutorials()
        }
    ...
    private fun contactSupport() {
        val intent = Intent(Intent.ACTION_SENDTO).apply {
            data = Uri.parse("mailto:support@aksaranotes.com")
            putExtra(Intent.EXTRA_SUBJECT, "Aksara Notes - Support Request")
            putExtra(Intent.EXTRA_TEXT, buildString {
                appendLine("Hi Aksara Notes Support Team,")
                appendLine()
                appendLine("I need help with:")
                appendLine()
    ...
    private fun openVideoTutorials() {
        val intent = Intent(Intent.ACTION_VIEW).apply {
            data = Uri.parse("https://youtube.com/@aksaranotes")
        }

        try {
            startActivity(intent)
        } catch (e: Exception) {
            showToast("Video tutorials will be available soon!")
        }
    }
