package com.aksara.aksaranotes.ui.settings
...
import com.aksara.aksaranotes.databinding.ActivityAboutBinding
...
class AboutActivity : AppCompatActivity() {
    ...
    private fun setupViews() {
        ...
        // Set build info
        binding.tvBuildInfo.text = "Built for Android ${android.os.Build.VERSION.SDK_INT}+"
    }
    ...
    private fun setupClickListeners() {
        ...
        // Contact Developer
        binding.cardContactDeveloper.setOnClickListener {
            contactDeveloper()
        }
    ...
    private fun contactDeveloper() {
        val intent = Intent(Intent.ACTION_SENDTO).apply {
            data = Uri.parse("mailto:developer@aksaranotes.com")
            putExtra(Intent.EXTRA_SUBJECT, "Aksara Notes - Feedback")
            putExtra(Intent.EXTRA_TEXT, buildString {
                appendLine("Hi Aksara Notes Team,")
                appendLine()
                appendLine("App Version: ${binding.tvVersion.text}")
                appendLine("Device: ${android.os.Build.MANUFACTURER} ${android.os.Build.MODEL}")
                appendLine("Android: ${android.os.Build.VERSION.RELEASE}")
                appendLine()
                appendLine("My feedback/question:")
                appendLine()
            })
        }
